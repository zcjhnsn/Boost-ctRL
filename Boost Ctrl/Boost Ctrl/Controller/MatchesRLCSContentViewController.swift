...
class MatchesRLCSContentViewController: UIViewController {
	...
	let regionNames = ["North America", "Europe", "Oceania"]
	var isRLCS = true
...
//			self.matchesArray.append(self.matchesOCE)
//			
...
extension MatchesRLCSContentViewController: UITableViewDelegate, UITableViewDataSource {
