...
extension ProgressViewStyle {
    ...
    /// A progress view that visually indicates its progress using a gauge.
    /// - Parameter thickness: The thickness of the gauge.
    /// - Parameter indicatorColor: The fill color of the gauge pointer
    /// - Parameter indicatorStrokeColor: The stroke color of the gauge pointer
    /// - Returns: A view representing the body of a progress view with traffic light angular gradient and no labels for the lowest and highest value.
    public static func gauge(thickness: CGFloat = 12, indicatorColor: Color = .clear, indicatorStrokeColor: Color = .black) -> GaugeProgressViewStyle<AngularGradient, EmptyView, EmptyView> where Self == GaugeProgressViewStyle<AngularGradient, EmptyView, EmptyView> {
        return GaugeProgressViewStyle(
            shape: .trafficLight,
            thickness: thickness,
